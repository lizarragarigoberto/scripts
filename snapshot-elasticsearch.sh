...
echo -n 'AKIAUUUUUUUUUUUUUUU' | ./elasticsearch-keystore add --stdin s3.client.default.access_key
echo -n 'AZZZZZZZZZZZZZZZZZZZZZZZZB' | ./elasticsearch-keystore add --stdin s3.client.default.secret_key
